...
void LCD_Init(void){
    //4bits -> RD0 RD3
    LCD_PORT = LCD_PORT & 0x00f0;//0xfff0;//0XF0
    /*         RD7    RD0
     *         1111  0000
     *                 0 
     */
    LCD_TRIS &= 0xfff0;//0xf0 //LCD_TRIS = LCD_TRIS & 0xf0;
    ...
    __delay_ms(40); //Segun datasheet //15 lo cabie por los 3.3v
    LCD_Comando(0x30);
    __delay_ms(5);
    LCD_Comando(0x30);
    __delay_us(100);
...
void LCD_Comando(unsigned char cmd){
    //30 = 0011 0000 
    LCD_PORT &= 0x00f0;//0xfff0;//0xfff0
   // LCD_TRIS &= 0xfff0;//0xfff0     *** puedes quitarlo
   ...
   // LCD_TRIS |= 0x000f;//0x0f       *** puedes quitarlo
...
void LCD_Data(char data){
    __delay_us(100);
    LCD_PORT &= 0x00f0;//0xfff0;//0xf0
  //  LCD_TRIS &= 0xfff0;//0xf0         *** lo puedes quitar
   ...
   // LCD_TRIS |= 0x000f;//0x000f           *** lo puedes quitar
